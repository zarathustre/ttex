...
class Ui_create_scenario_page(object):
    ...
    def retranslateUi(self, create_scenario_page):
        ...
        self.back_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Back to home page", None))
...
#if QT_CONFIG(statustip)
        self.title_edit.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Scenario title", None))
#endif // QT_CONFIG(statustip)
        self.label_2.setText(QCoreApplication.translate("create_scenario_page", u"Scenario", None))
#if QT_CONFIG(statustip)
        self.scenario_edit.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Main scenario exercise", None))
#endif // QT_CONFIG(statustip)
        self.create_scenario_tab.setTabText(self.create_scenario_tab.indexOf(self.tab_1), QCoreApplication.translate("create_scenario_page", u"Title / Scenario", None))
        self.objectives_group.setTitle(QCoreApplication.translate("create_scenario_page", u"Objectives", None))
#if QT_CONFIG(statustip)
        self.objectives_edit.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Objective", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(statustip)
        self.add_objective_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Add new objective", None))
#endif // QT_CONFIG(statustip)
        self.add_objective_button.setText(QCoreApplication.translate("create_scenario_page", u"+", None))
#if QT_CONFIG(statustip)
        self.remove_objetive_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Remove last objective", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.injects_edit.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Inject", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(statustip)
        self.add_inject_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Add new inject", None))
#endif // QT_CONFIG(statustip)
        self.add_inject_button.setText(QCoreApplication.translate("create_scenario_page", u"+", None))
#if QT_CONFIG(statustip)
        self.remove_inject_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Remove last inject", None))
#endif // QT_CONFIG(statustip)
        self.remove_inject_button.setText(QCoreApplication.translate("create_scenario_page", u"-", None))
        self.create_scenario_tab.setTabText(self.create_scenario_tab.indexOf(self.tab_2), QCoreApplication.translate("create_scenario_page", u"Objectives / Injects", None))
        self.questions_group.setTitle(QCoreApplication.translate("create_scenario_page", u"Questions", None))
#if QT_CONFIG(statustip)
        self.question_edit.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Question", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(statustip)
        self.question_combo_box.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Question weight", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(tooltip)
        self.add_question_button.setToolTip(QCoreApplication.translate("create_scenario_page", u"Every question must be associated with an answer", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.add_question_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Add new question", None))
#endif // QT_CONFIG(statustip)
        self.add_question_button.setText(QCoreApplication.translate("create_scenario_page", u"+", None))
#if QT_CONFIG(statustip)
        self.remove_question_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Remove last question", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.answer_edit.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Answer", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(statustip)
        self.add_answer_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Add new answer", None))
#endif // QT_CONFIG(statustip)
        self.add_answer_button.setText(QCoreApplication.translate("create_scenario_page", u"+", None))
#if QT_CONFIG(statustip)
        self.remove_answer_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Remove last answer", None))
#endif // QT_CONFIG(statustip)
        self.remove_answer_button.setText(QCoreApplication.translate("create_scenario_page", u"-", None))
        self.create_scenario_tab.setTabText(self.create_scenario_tab.indexOf(self.tab_3), QCoreApplication.translate("create_scenario_page", u"Questions / Answers", None))
#if QT_CONFIG(statustip)
        self.clear_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Clear entries on this page", None))
#endif // QT_CONFIG(statustip)
        self.clear_button.setText(QCoreApplication.translate("create_scenario_page", u"Clear", None))
#if QT_CONFIG(statustip)
        self.next_button.setStatusTip(QCoreApplication.translate("create_scenario_page", u"Go to next tab", None))
#endif // QT_CONFIG(statustip)
